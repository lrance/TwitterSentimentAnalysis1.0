...
tf = TfidfVectorizer(sublinear_tf = True, analyzer='word', lowercase=True,ngram_range=(1,1),min_df=1,stop_words='english')
...
features_train = features_train[:100000]
labels_train   = labels_train[:100000]
