...
def evaluate_features(feature_select):
    ...
    for traincv, testcv in cv:
        ...
        print("Bernoulli_Accu", Bernoulli_Accu)
        Bernoulli_Accu += Bernoulli_Accu
        ...
        print("Multinomial_Accu", Multinomial_Accu)
        Multinomial_Accu += Multinomial_Accu
    ...
    Bernoulli_Accu = Bernoulli_Accu/2
